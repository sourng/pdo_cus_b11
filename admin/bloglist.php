...
class cblog_list extends cblog {
	...
	function RenderListOptions() {
		...
		if ($Security->IsLoggedIn()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewEdit\" title=\"" . $editcaption . "\" data-table=\"blog\" data-caption=\"" . $editcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'SaveBtn',url:'" . ew_HtmlEncode($this->EditUrl) . "'});\">" . $Language->Phrase("EditLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->IsLoggedIn()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewCopy\" title=\"" . $copycaption . "\" data-table=\"blog\" data-caption=\"" . $copycaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'AddBtn',url:'" . ew_HtmlEncode($this->CopyUrl) . "'});\">" . $Language->Phrase("CopyLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
	...
	function SetupOtherOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<a class=\"ewAddEdit ewAdd\" title=\"" . $addcaption . "\" data-table=\"blog\" data-caption=\"" . $addcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'AddBtn',url:'" . ew_HtmlEncode($this->AddUrl) . "'});\">" . $Language->Phrase("AddLink") . "</a>";
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fbloglist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function RenderRow() {
		...
		$this->status->ViewCustomAttributes = "";
			...
			if ($this->image->UseColorbox) {
				...
				$this->image->LinkAttrs["data-rel"] = "blog_x" . $this->RowCnt . "_image";
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_blog\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_blog',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fbloglist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
<?php if ($blog->id->Visible) { // id ?>
	<?php if ($blog->SortUrl($blog->id) == "") { ?>
		<th data-name="id" class="<?php echo $blog->id->HeaderCellClass() ?>"><div id="elh_blog_id" class="blog_id"><div class="ewTableHeaderCaption"><?php echo $blog->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id" class="<?php echo $blog->id->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $blog->SortUrl($blog->id) ?>',1);"><div id="elh_blog_id" class="blog_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $blog->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($blog->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($blog->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($blog->title->Visible) { // title ?>
	<?php if ($blog->SortUrl($blog->title) == "") { ?>
		<th data-name="title" class="<?php echo $blog->title->HeaderCellClass() ?>"><div id="elh_blog_title" class="blog_title"><div class="ewTableHeaderCaption"><?php echo $blog->title->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="title" class="<?php echo $blog->title->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $blog->SortUrl($blog->title) ?>',1);"><div id="elh_blog_title" class="blog_title">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $blog->title->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($blog->title->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($blog->title->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($blog->image->Visible) { // image ?>
	<?php if ($blog->SortUrl($blog->image) == "") { ?>
		<th data-name="image" class="<?php echo $blog->image->HeaderCellClass() ?>"><div id="elh_blog_image" class="blog_image"><div class="ewTableHeaderCaption"><?php echo $blog->image->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="image" class="<?php echo $blog->image->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $blog->SortUrl($blog->image) ?>',1);"><div id="elh_blog_image" class="blog_image">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $blog->image->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($blog->image->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($blog->image->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($blog->create_date->Visible) { // create_date ?>
	<?php if ($blog->SortUrl($blog->create_date) == "") { ?>
		<th data-name="create_date" class="<?php echo $blog->create_date->HeaderCellClass() ?>"><div id="elh_blog_create_date" class="blog_create_date"><div class="ewTableHeaderCaption"><?php echo $blog->create_date->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="create_date" class="<?php echo $blog->create_date->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $blog->SortUrl($blog->create_date) ?>',1);"><div id="elh_blog_create_date" class="blog_create_date">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $blog->create_date->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($blog->create_date->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($blog->create_date->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
if ($objForm) {
	$objForm->Index = -1;
	if ($objForm->HasValue($blog_list->FormKeyCountName) && ($blog->CurrentAction == "gridadd" || $blog->CurrentAction == "gridedit" || $blog->CurrentAction == "F")) {
		$blog_list->KeyCount = $objForm->GetValue($blog_list->FormKeyCountName);
		$blog_list->StopRec = $blog_list->StartRec + $blog_list->KeyCount - 1;
	}
}
...
$blog->ResetAttrs();
$blog_list->RenderRow();
if ($blog->CurrentAction == "gridedit")
	$blog_list->RowIndex = 0;
while ($blog_list->RecCnt < $blog_list->StopRec) {
	$blog_list->RecCnt++;
	if (intval($blog_list->RecCnt) >= intval($blog_list->StartRec)) {
		$blog_list->RowCnt++;
		if ($blog->CurrentAction == "gridadd" || $blog->CurrentAction == "gridedit" || $blog->CurrentAction == "F") {
			$blog_list->RowIndex++;
			$objForm->Index = $blog_list->RowIndex;
			if ($objForm->HasValue($blog_list->FormActionName))
				$blog_list->RowAction = strval($objForm->GetValue($blog_list->FormActionName));
			elseif ($blog->CurrentAction == "gridadd")
				$blog_list->RowAction = "insert";
			else
				$blog_list->RowAction = "";
		}
		...
		if ($blog->CurrentAction == "gridadd") {
			$blog_list->LoadRowValues(); // Load default values
		} else {
			$blog_list->LoadRowValues($blog_list->Recordset); // Load row values
		}
		$blog->RowType = EW_ROWTYPE_VIEW; // Render view
		if ($blog->CurrentAction == "gridedit") { // Grid edit
			if ($blog->EventCancelled) {
				$blog_list->RestoreCurrentRowFormValues($blog_list->RowIndex); // Restore form values
			}
			if ($blog_list->RowAction == "insert")
				$blog->RowType = EW_ROWTYPE_ADD; // Render add
			else
				$blog->RowType = EW_ROWTYPE_EDIT; // Render edit
		}
		if ($blog->CurrentAction == "gridedit" && ($blog->RowType == EW_ROWTYPE_EDIT || $blog->RowType == EW_ROWTYPE_ADD) && $blog->EventCancelled) // Update failed
			$blog_list->RestoreCurrentRowFormValues($blog_list->RowIndex); // Restore form values
		if ($blog->RowType == EW_ROWTYPE_EDIT) // Edit row
			$blog_list->EditRowCnt++;
		...
		if ($blog_list->RowAction <> "delete" && $blog_list->RowAction <> "insertdelete" && !($blog_list->RowAction == "insert" && $blog->CurrentAction == "F" && $blog_list->EmptyRow())) {
?>
...
<?php if ($blog->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<input type="hidden" data-table="blog" data-field="x_id" name="o<?php echo $blog_list->RowIndex ?>_id" id="o<?php echo $blog_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($blog->id->OldValue) ?>">
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_id" class="form-group blog_id">
<span<?php echo $blog->id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $blog->id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="blog" data-field="x_id" name="x<?php echo $blog_list->RowIndex ?>_id" id="x<?php echo $blog_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($blog->id->CurrentValue) ?>">
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_id" class="blog_id">
<span<?php echo $blog->id->ViewAttributes() ?>>
<?php echo $blog->id->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($blog->title->Visible) { // title ?>
		<td data-name="title"<?php echo $blog->title->CellAttributes() ?>>
<?php if ($blog->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_title" class="form-group blog_title">
<input type="text" data-table="blog" data-field="x_title" name="x<?php echo $blog_list->RowIndex ?>_title" id="x<?php echo $blog_list->RowIndex ?>_title" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($blog->title->getPlaceHolder()) ?>" value="<?php echo $blog->title->EditValue ?>"<?php echo $blog->title->EditAttributes() ?>>
</span>
<input type="hidden" data-table="blog" data-field="x_title" name="o<?php echo $blog_list->RowIndex ?>_title" id="o<?php echo $blog_list->RowIndex ?>_title" value="<?php echo ew_HtmlEncode($blog->title->OldValue) ?>">
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_title" class="form-group blog_title">
<input type="text" data-table="blog" data-field="x_title" name="x<?php echo $blog_list->RowIndex ?>_title" id="x<?php echo $blog_list->RowIndex ?>_title" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($blog->title->getPlaceHolder()) ?>" value="<?php echo $blog->title->EditValue ?>"<?php echo $blog->title->EditAttributes() ?>>
...
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_title" class="blog_title">
<span<?php echo $blog->title->ViewAttributes() ?>>
<?php echo $blog->title->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($blog->image->Visible) { // image ?>
		<td data-name="image"<?php echo $blog->image->CellAttributes() ?>>
<?php if ($blog->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_image" class="form-group blog_image">
<div id="fd_x<?php echo $blog_list->RowIndex ?>_image">
<span title="<?php echo $blog->image->FldTitle() ? $blog->image->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($blog->image->ReadOnly || $blog->image->Disabled) echo " hide"; ?>" data-trigger="hover">
	...
	<input type="file" title=" " data-table="blog" data-field="x_image" name="x<?php echo $blog_list->RowIndex ?>_image" id="x<?php echo $blog_list->RowIndex ?>_image"<?php echo $blog->image->EditAttributes() ?>>
</span>
<input type="hidden" name="fn_x<?php echo $blog_list->RowIndex ?>_image" id= "fn_x<?php echo $blog_list->RowIndex ?>_image" value="<?php echo $blog->image->Upload->FileName ?>">
<input type="hidden" name="fa_x<?php echo $blog_list->RowIndex ?>_image" id= "fa_x<?php echo $blog_list->RowIndex ?>_image" value="0">
<input type="hidden" name="fs_x<?php echo $blog_list->RowIndex ?>_image" id= "fs_x<?php echo $blog_list->RowIndex ?>_image" value="-1">
<input type="hidden" name="fx_x<?php echo $blog_list->RowIndex ?>_image" id= "fx_x<?php echo $blog_list->RowIndex ?>_image" value="<?php echo $blog->image->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x<?php echo $blog_list->RowIndex ?>_image" id= "fm_x<?php echo $blog_list->RowIndex ?>_image" value="<?php echo $blog->image->UploadMaxFileSize ?>">
</div>
<table id="ft_x<?php echo $blog_list->RowIndex ?>_image" class="table table-condensed pull-left ewUploadTable"><tbody class="files"></tbody></table>
</span>
<input type="hidden" data-table="blog" data-field="x_image" name="o<?php echo $blog_list->RowIndex ?>_image" id="o<?php echo $blog_list->RowIndex ?>_image" value="<?php echo ew_HtmlEncode($blog->image->OldValue) ?>">
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_image" class="form-group blog_image">
<div id="fd_x<?php echo $blog_list->RowIndex ?>_image">
...
<input type="hidden" name="fn_x<?php echo $blog_list->RowIndex ?>_image" id= "fn_x<?php echo $blog_list->RowIndex ?>_image" value="<?php echo $blog->image->Upload->FileName ?>">
<?php if (@$_POST["fa_x<?php echo $blog_list->RowIndex ?>_image"] == "0") { ?>
<input type="hidden" name="fa_x<?php echo $blog_list->RowIndex ?>_image" id= "fa_x<?php echo $blog_list->RowIndex ?>_image" value="0">
<?php } else { ?>
<input type="hidden" name="fa_x<?php echo $blog_list->RowIndex ?>_image" id= "fa_x<?php echo $blog_list->RowIndex ?>_image" value="1">
<?php } ?>
<input type="hidden" name="fs_x<?php echo $blog_list->RowIndex ?>_image" id= "fs_x<?php echo $blog_list->RowIndex ?>_image" value="-1">
<input type="hidden" name="fx_x<?php echo $blog_list->RowIndex ?>_image" id= "fx_x<?php echo $blog_list->RowIndex ?>_image" value="<?php echo $blog->image->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x<?php echo $blog_list->RowIndex ?>_image" id= "fm_x<?php echo $blog_list->RowIndex ?>_image" value="<?php echo $blog->image->UploadMaxFileSize ?>">
...
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_image" class="blog_image">
<span>
<?php echo ew_GetFileViewTag($blog->image, $blog->image->ListViewValue()) ?>
</span>
</span>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($blog->create_date->Visible) { // create_date ?>
		<td data-name="create_date"<?php echo $blog->create_date->CellAttributes() ?>>
<?php if ($blog->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_create_date" class="form-group blog_create_date">
<input type="text" data-table="blog" data-field="x_create_date" name="x<?php echo $blog_list->RowIndex ?>_create_date" id="x<?php echo $blog_list->RowIndex ?>_create_date" placeholder="<?php echo ew_HtmlEncode($blog->create_date->getPlaceHolder()) ?>" value="<?php echo $blog->create_date->EditValue ?>"<?php echo $blog->create_date->EditAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fbloglist", "x<?php echo $blog_list->RowIndex ?>_create_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
<input type="hidden" data-table="blog" data-field="x_create_date" name="o<?php echo $blog_list->RowIndex ?>_create_date" id="o<?php echo $blog_list->RowIndex ?>_create_date" value="<?php echo ew_HtmlEncode($blog->create_date->OldValue) ?>">
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_create_date" class="form-group blog_create_date">
<input type="text" data-table="blog" data-field="x_create_date" name="x<?php echo $blog_list->RowIndex ?>_create_date" id="x<?php echo $blog_list->RowIndex ?>_create_date" placeholder="<?php echo ew_HtmlEncode($blog->create_date->getPlaceHolder()) ?>" value="<?php echo $blog->create_date->EditValue ?>"<?php echo $blog->create_date->EditAttributes() ?>>
...
<?php } ?>
<?php if ($blog->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $blog_list->RowCnt ?>_blog_create_date" class="blog_create_date">
<span<?php echo $blog->create_date->ViewAttributes() ?>>
<?php echo $blog->create_date->ListViewValue() ?></span>
</span>
<?php } ?>
</td>
	<?php } ?>
...
<?php if ($blog->RowType == EW_ROWTYPE_ADD || $blog->RowType == EW_ROWTYPE_EDIT) { ?>
<script type="text/javascript">
fbloglist.UpdateOpts(<?php echo $blog_list->RowIndex ?>);
</script>
<?php } ?>
<?php
	}
	...
	if ($blog->CurrentAction <> "gridadd")
		if (!$blog_list->Recordset->EOF) $blog_list->Recordset->MoveNext();
}
?>
<?php
	if ($blog->CurrentAction == "gridadd" || $blog->CurrentAction == "gridedit") {
		$blog_list->RowIndex = '$rowindex$';
		$blog_list->LoadRowValues();

		// Set row properties
		$blog->ResetAttrs();
		$blog->RowAttrs = array_merge($blog->RowAttrs, array('data-rowindex'=>$blog_list->RowIndex, 'id'=>'r0_blog', 'data-rowtype'=>EW_ROWTYPE_ADD));
		ew_AppendClass($blog->RowAttrs["class"], "ewTemplate");
		$blog->RowType = EW_ROWTYPE_ADD;
		...
		// Render list options
		$blog_list->RenderListOptions();
		$blog_list->StartRowCnt = 0;
?>
	<tr<?php echo $blog->RowAttributes() ?>>
<?php

// Render list options (body, left)
$blog_list->ListOptions->Render("body", "left", $blog_list->RowIndex);
?>
	<?php if ($blog->id->Visible) { // id ?>
		<td data-name="id">
<input type="hidden" data-table="blog" data-field="x_id" name="o<?php echo $blog_list->RowIndex ?>_id" id="o<?php echo $blog_list->RowIndex ?>_id" value="<?php echo ew_HtmlEncode($blog->id->OldValue) ?>">
	...
	<?php if ($blog->title->Visible) { // title ?>
		<td data-name="title">
<span id="el$rowindex$_blog_title" class="form-group blog_title">
<input type="text" data-table="blog" data-field="x_title" name="x<?php echo $blog_list->RowIndex ?>_title" id="x<?php echo $blog_list->RowIndex ?>_title" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($blog->title->getPlaceHolder()) ?>" value="<?php echo $blog->title->EditValue ?>"<?php echo $blog->title->EditAttributes() ?>>
</span>
<input type="hidden" data-table="blog" data-field="x_title" name="o<?php echo $blog_list->RowIndex ?>_title" id="o<?php echo $blog_list->RowIndex ?>_title" value="<?php echo ew_HtmlEncode($blog->title->OldValue) ?>">
</td>
	...
	<?php if ($blog->image->Visible) { // image ?>
		<td data-name="image">
<span id="el$rowindex$_blog_image" class="form-group blog_image">
<div id="fd_x<?php echo $blog_list->RowIndex ?>_image">
<span title="<?php echo $blog->image->FldTitle() ? $blog->image->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($blog->image->ReadOnly || $blog->image->Disabled) echo " hide"; ?>" data-trigger="hover">
	<span><?php echo $Language->Phrase("ChooseFileBtn") ?></span>
	<input type="file" title=" " data-table="blog" data-field="x_image" name="x<?php echo $blog_list->RowIndex ?>_image" id="x<?php echo $blog_list->RowIndex ?>_image"<?php echo $blog->image->EditAttributes() ?>>
...
<span id="el$rowindex$_blog_create_date" class="form-group blog_create_date">
<input type="text" data-table="blog" data-field="x_create_date" name="x<?php echo $blog_list->RowIndex ?>_create_date" id="x<?php echo $blog_list->RowIndex ?>_create_date" placeholder="<?php echo ew_HtmlEncode($blog->create_date->getPlaceHolder()) ?>" value="<?php echo $blog->create_date->EditValue ?>"<?php echo $blog->create_date->EditAttributes() ?>>
<?php if (!$blog->create_date->ReadOnly && !$blog->create_date->Disabled && !isset($blog->create_date->EditAttrs["readonly"]) && !isset($blog->create_date->EditAttrs["disabled"])) { ?>
<script type="text/javascript">
ew_CreateDateTimePicker("fbloglist", "x<?php echo $blog_list->RowIndex ?>_create_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
...
// Render list options (body, right)
$blog_list->ListOptions->Render("body", "right", $blog_list->RowIndex);
?>
<script type="text/javascript">
fbloglist.UpdateOpts(<?php echo $blog_list->RowIndex ?>);
</script>
...
<?php } ?>
<?php if ($blog->CurrentAction == "gridedit") { ?>
<input type="hidden" name="a_list" id="a_list" value="gridupdate">
<input type="hidden" name="<?php echo $blog_list->FormKeyCountName ?>" id="<?php echo $blog_list->FormKeyCountName ?>" value="<?php echo $blog_list->KeyCount ?>">
<?php echo $blog_list->MultiSelectKey ?>
<?php } ?>
