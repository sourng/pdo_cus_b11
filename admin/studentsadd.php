...
class cstudents_add extends cstudents {
	...
	function AddRow($rsold = NULL) {
		...
		// about
		$this->about->SetDbValueDef($rsnew, $this->about->CurrentValue, NULL, FALSE);
...
<?php if ($students->first_name->Visible) { // first_name ?>
	<div id="r_first_name" class="form-group">
		<label id="elh_students_first_name" for="x_first_name" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->first_name->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->first_name->CellAttributes() ?>>
...
<?php if ($students->last_name->Visible) { // last_name ?>
	<div id="r_last_name" class="form-group">
		<label id="elh_students_last_name" for="x_last_name" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->last_name->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->last_name->CellAttributes() ?>>
...
<?php if ($students->name->Visible) { // name ?>
	<div id="r_name" class="form-group">
		<label id="elh_students_name" for="x_name" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->name->FldCaption() ?></label>
...
<?php if ($students->gender->Visible) { // gender ?>
	<div id="r_gender" class="form-group">
		<label id="elh_students_gender" for="x_gender" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->gender->FldCaption() ?></label>
...
<?php if ($students->bod->Visible) { // bod ?>
	<div id="r_bod" class="form-group">
		<label id="elh_students_bod" for="x_bod" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->bod->FldCaption() ?></label>
...
<?php if ($students->phone->Visible) { // phone ?>
	<div id="r_phone" class="form-group">
		<label id="elh_students_phone" for="x_phone" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->phone->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->phone->CellAttributes() ?>>
...
<?php if ($students->_email->Visible) { // email ?>
	<div id="r__email" class="form-group">
		<label id="elh_students__email" for="x__email" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->_email->FldCaption() ?></label>
...
<?php if ($students->pass->Visible) { // pass ?>
	<div id="r_pass" class="form-group">
		<label id="elh_students_pass" for="x_pass" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->pass->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->pass->CellAttributes() ?>>
...
<?php if ($students->fb->Visible) { // fb ?>
	<div id="r_fb" class="form-group">
		<label id="elh_students_fb" for="x_fb" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->fb->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->fb->CellAttributes() ?>>
...
<?php if ($students->tw->Visible) { // tw ?>
	<div id="r_tw" class="form-group">
		<label id="elh_students_tw" for="x_tw" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->tw->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->tw->CellAttributes() ?>>
...
<?php if ($students->gplus->Visible) { // gplus ?>
	<div id="r_gplus" class="form-group">
		<label id="elh_students_gplus" for="x_gplus" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->gplus->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->gplus->CellAttributes() ?>>
...
<?php if ($students->about->Visible) { // about ?>
	<div id="r_about" class="form-group">
		<label id="elh_students_about" for="x_about" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->about->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->about->CellAttributes() ?>>
...
<?php if ($students->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_students_status" for="x_status" class="<?php echo $students_add->LeftColumnClass ?>"><?php echo $students->status->FldCaption() ?></label>
		<div class="<?php echo $students_add->RightColumnClass ?>"><div<?php echo $students->status->CellAttributes() ?>>
