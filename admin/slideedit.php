...
class cslide_edit extends cslide {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_slide_id")) {
	...
	function LoadFormValues() {
		...
		if (!$this->slide_id->FldIsDetailKey)
			$this->slide_id->setFormValue($objForm->GetValue("x_slide_id"));
...
fslideedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<input type="hidden" name="modal" value="<?php echo intval($slide_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($slide->slide_id->Visible) { // slide_id ?>
	<div id="r_slide_id" class="form-group">
		<label id="elh_slide_slide_id" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->slide_id->FldCaption() ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->slide_id->CellAttributes() ?>>
<span id="el_slide_slide_id">
<span<?php echo $slide->slide_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $slide->slide_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="slide" data-field="x_slide_id" name="x_slide_id" id="x_slide_id" value="<?php echo ew_HtmlEncode($slide->slide_id->CurrentValue) ?>">
<?php echo $slide->slide_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slide->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_slide_title" for="x_title" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->title->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->title->CellAttributes() ?>>
<span id="el_slide_title">
<input type="text" data-table="slide" data-field="x_title" name="x_title" id="x_title" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->title->getPlaceHolder()) ?>" value="<?php echo $slide->title->EditValue ?>"<?php echo $slide->title->EditAttributes() ?>>
</span>
<?php echo $slide->title->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slide->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_slide_description" for="x_description" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->description->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->description->CellAttributes() ?>>
<span id="el_slide_description">
<input type="text" data-table="slide" data-field="x_description" name="x_description" id="x_description" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->description->getPlaceHolder()) ?>" value="<?php echo $slide->description->EditValue ?>"<?php echo $slide->description->EditAttributes() ?>>
</span>
<?php echo $slide->description->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slide->img->Visible) { // img ?>
	<div id="r_img" class="form-group">
		<label id="elh_slide_img" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->img->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->img->CellAttributes() ?>>
...
<span title="<?php echo $slide->img->FldTitle() ? $slide->img->FldTitle() : $Language->Phrase("ChooseFile") ?>" class="btn btn-default btn-sm fileinput-button ewTooltip<?php if ($slide->img->ReadOnly || $slide->img->Disabled) echo " hide"; ?>" data-trigger="hover">
	...
	<input type="file" title=" " data-table="slide" data-field="x_img" name="x_img" id="x_img"<?php echo $slide->img->EditAttributes() ?>>
</span>
<input type="hidden" name="fn_x_img" id= "fn_x_img" value="<?php echo $slide->img->Upload->FileName ?>">
...
<?php } ?>
<input type="hidden" name="fs_x_img" id= "fs_x_img" value="250">
<input type="hidden" name="fx_x_img" id= "fx_x_img" value="<?php echo $slide->img->UploadAllowedFileExt ?>">
<input type="hidden" name="fm_x_img" id= "fm_x_img" value="<?php echo $slide->img->UploadMaxFileSize ?>">
</div>
<table id="ft_x_img" class="table table-condensed pull-left ewUploadTable"><tbody class="files"></tbody></table>
</span>
<?php echo $slide->img->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slide->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_slide_status" for="x_status" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->status->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->status->CellAttributes() ?>>
<span id="el_slide_status">
<input type="text" data-table="slide" data-field="x_status" name="x_status" id="x_status" size="30" placeholder="<?php echo ew_HtmlEncode($slide->status->getPlaceHolder()) ?>" value="<?php echo $slide->status->EditValue ?>"<?php echo $slide->status->EditAttributes() ?>>
</span>
<?php echo $slide->status->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slide->url->Visible) { // url ?>
	<div id="r_url" class="form-group">
		<label id="elh_slide_url" for="x_url" class="<?php echo $slide_edit->LeftColumnClass ?>"><?php echo $slide->url->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $slide_edit->RightColumnClass ?>"><div<?php echo $slide->url->CellAttributes() ?>>
<span id="el_slide_url">
<input type="text" data-table="slide" data-field="x_url" name="x_url" id="x_url" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->url->getPlaceHolder()) ?>" value="<?php echo $slide->url->EditValue ?>"<?php echo $slide->url->EditAttributes() ?>>
</span>
<?php echo $slide->url->CustomMsg ?></div></div>
	</div>
<?php } ?>
</div><!-- /page* -->
<?php if (!$slide_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $slide_edit->OffsetColumnClass ?>"><!-- buttons offset -->
