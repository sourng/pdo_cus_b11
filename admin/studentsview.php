...
$students_view = NULL; // Initialize page object first

class cstudents_view extends cstudents {
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("studentslist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->stu_id->CurrentValue) == strval($this->Recordset->fields('stu_id'))) {
...
// Create page object
if (!isset($students_view)) $students_view = new cstudents_view();
...
var CurrentForm = fstudentsview = new ew_Form("fstudentsview", "view");

// Form_CustomValidate event
fstudentsview.Form_CustomValidate = 
...
fstudentsview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
?>
<?php if (!$students_view->IsModal) { ?>
<?php if ($students->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($students_view->Pager)) $students_view->Pager = new cPrevNextPager($students_view->StartRec, $students_view->DisplayRecs, $students_view->TotalRecs, $students_view->AutoHidePager) ?>
<?php if ($students_view->Pager->RecordCount > 0 && $students_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($students_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $students_view->PageUrl() ?>start=<?php echo $students_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($students_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $students_view->PageUrl() ?>start=<?php echo $students_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $students_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($students_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $students_view->PageUrl() ?>start=<?php echo $students_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($students_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $students_view->PageUrl() ?>start=<?php echo $students_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $students_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="fstudentsview" id="fstudentsview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($students_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $students_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="students">
<input type="hidden" name="modal" value="<?php echo intval($students_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($students->stu_id->Visible) { // stu_id ?>
	<tr id="r_stu_id">
		<td class="col-sm-2"><span id="elh_students_stu_id"><?php echo $students->stu_id->FldCaption() ?></span></td>
...
<?php echo $students->stu_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->first_name->Visible) { // first_name ?>
	<tr id="r_first_name">
		<td class="col-sm-2"><span id="elh_students_first_name"><?php echo $students->first_name->FldCaption() ?></span></td>
...
<?php echo $students->first_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->last_name->Visible) { // last_name ?>
	<tr id="r_last_name">
		<td class="col-sm-2"><span id="elh_students_last_name"><?php echo $students->last_name->FldCaption() ?></span></td>
...
<?php echo $students->last_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->name->Visible) { // name ?>
	<tr id="r_name">
		<td class="col-sm-2"><span id="elh_students_name"><?php echo $students->name->FldCaption() ?></span></td>
...
<?php echo $students->name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->gender->Visible) { // gender ?>
	<tr id="r_gender">
		<td class="col-sm-2"><span id="elh_students_gender"><?php echo $students->gender->FldCaption() ?></span></td>
...
<?php echo $students->gender->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->bod->Visible) { // bod ?>
	<tr id="r_bod">
		<td class="col-sm-2"><span id="elh_students_bod"><?php echo $students->bod->FldCaption() ?></span></td>
		<td data-name="bod"<?php echo $students->bod->CellAttributes() ?>>
<span id="el_students_bod">
<span<?php echo $students->bod->ViewAttributes() ?>>
<?php echo $students->bod->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->phone->Visible) { // phone ?>
	<tr id="r_phone">
		<td class="col-sm-2"><span id="elh_students_phone"><?php echo $students->phone->FldCaption() ?></span></td>
...
<?php echo $students->phone->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->_email->Visible) { // email ?>
	<tr id="r__email">
		<td class="col-sm-2"><span id="elh_students__email"><?php echo $students->_email->FldCaption() ?></span></td>
...
<?php echo $students->_email->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->pass->Visible) { // pass ?>
	<tr id="r_pass">
		<td class="col-sm-2"><span id="elh_students_pass"><?php echo $students->pass->FldCaption() ?></span></td>
...
<?php echo $students->pass->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->fb->Visible) { // fb ?>
	<tr id="r_fb">
		<td class="col-sm-2"><span id="elh_students_fb"><?php echo $students->fb->FldCaption() ?></span></td>
		<td data-name="fb"<?php echo $students->fb->CellAttributes() ?>>
<span id="el_students_fb">
<span<?php echo $students->fb->ViewAttributes() ?>>
<?php echo $students->fb->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->tw->Visible) { // tw ?>
	<tr id="r_tw">
		<td class="col-sm-2"><span id="elh_students_tw"><?php echo $students->tw->FldCaption() ?></span></td>
		<td data-name="tw"<?php echo $students->tw->CellAttributes() ?>>
<span id="el_students_tw">
<span<?php echo $students->tw->ViewAttributes() ?>>
<?php echo $students->tw->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->gplus->Visible) { // gplus ?>
	<tr id="r_gplus">
		<td class="col-sm-2"><span id="elh_students_gplus"><?php echo $students->gplus->FldCaption() ?></span></td>
...
<?php echo $students->gplus->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->about->Visible) { // about ?>
	<tr id="r_about">
		<td class="col-sm-2"><span id="elh_students_about"><?php echo $students->about->FldCaption() ?></span></td>
		<td data-name="about"<?php echo $students->about->CellAttributes() ?>>
<span id="el_students_about">
<span<?php echo $students->about->ViewAttributes() ?>>
<?php echo $students->about->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($students->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_students_status"><?php echo $students->status->FldCaption() ?></span></td>
...
<?php echo $students->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
