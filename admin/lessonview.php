...
$lesson_view = NULL; // Initialize page object first

class clesson_view extends clesson {
	...
	function Page_Init() {
		...
		if (@$_GET["lesson_id"] <> "") {
			...
			$gsExportFile .= $_GET["lesson_id"];
		}
		if (@$_GET["subject_id"] <> "") {
			if ($gsExportFile <> "") $gsExportFile .= "_";
			$gsExportFile .= $_GET["subject_id"];
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					...
					if ($this->TotalRecs <= 0) { // No record found
						...
						$this->Page_Terminate("lessonlist.php"); // Return to list page
						...
						while (!$this->Recordset->EOF) {
							if (strval($this->lesson_id->CurrentValue) == strval($this->Recordset->fields('lesson_id')) && strval($this->subject_id->CurrentValue) == strval($this->Recordset->fields('subject_id'))) {
					...
					if (!$bMatchRecord) {
						if ($this->getSuccessMessage() == "" && $this->getFailureMessage() == "")
							$this->setFailureMessage($Language->Phrase("NoRecord")); // Set no record message
						$sReturnUrl = "lessonlist.php"; // No matching record, return to list
					} else {
			...
			$sReturnUrl = "lessonlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_lesson\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_lesson',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.flessonview,key:" . ew_ArrayToJsonAttr($this->RecKey) . ",sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
...
// Create page object
if (!isset($lesson_view)) $lesson_view = new clesson_view();

// Page init
$lesson_view->Page_Init();

// Page main
$lesson_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$lesson_view->Page_Render();
?>
...
var CurrentForm = flessonview = new ew_Form("flessonview", "view");

// Form_CustomValidate event
flessonview.Form_CustomValidate = 
...
flessonview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;

// Dynamic selection lists
flessonview.Lists["x_subject_id"] = {"LinkField":"x_subject_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_subject_title","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"subject"};
flessonview.Lists["x_subject_id"].Data = "<?php echo $lesson_view->subject_id->LookupFilterQuery(FALSE, "view") ?>";
...
<?php if ($lesson->Export == "") { ?>
<div class="ewToolbar">
<?php $lesson_view->ExportOptions->Render("body") ?>
<?php
	foreach ($lesson_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php } ?>
<?php $lesson_view->ShowPageHeader(); ?>
<?php
$lesson_view->ShowMessage();
?>
<?php if (!$lesson_view->IsModal) { ?>
<?php if ($lesson->Export == "") { ?>
<form name="ewPagerForm" class="form-inline ewForm ewPagerForm" action="<?php echo ew_CurrentPage() ?>">
<?php if (!isset($lesson_view->Pager)) $lesson_view->Pager = new cPrevNextPager($lesson_view->StartRec, $lesson_view->DisplayRecs, $lesson_view->TotalRecs, $lesson_view->AutoHidePager) ?>
<?php if ($lesson_view->Pager->RecordCount > 0 && $lesson_view->Pager->Visible) { ?>
<div class="ewPager">
<span><?php echo $Language->Phrase("Page") ?>&nbsp;</span>
<div class="ewPrevNext"><div class="input-group">
<div class="input-group-btn">
<!--first page button-->
	<?php if ($lesson_view->Pager->FirstButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerFirst") ?>" href="<?php echo $lesson_view->PageUrl() ?>start=<?php echo $lesson_view->Pager->FirstButton->Start ?>"><span class="icon-first ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerFirst") ?>"><span class="icon-first ewIcon"></span></a>
	<?php } ?>
<!--previous page button-->
	<?php if ($lesson_view->Pager->PrevButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerPrevious") ?>" href="<?php echo $lesson_view->PageUrl() ?>start=<?php echo $lesson_view->Pager->PrevButton->Start ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerPrevious") ?>"><span class="icon-prev ewIcon"></span></a>
	<?php } ?>
</div>
<!--current page number-->
	<input class="form-control input-sm" type="text" name="<?php echo EW_TABLE_PAGE_NO ?>" value="<?php echo $lesson_view->Pager->CurrentPage ?>">
<div class="input-group-btn">
<!--next page button-->
	<?php if ($lesson_view->Pager->NextButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerNext") ?>" href="<?php echo $lesson_view->PageUrl() ?>start=<?php echo $lesson_view->Pager->NextButton->Start ?>"><span class="icon-next ewIcon"></span></a>
	<?php } else { ?>
	<a class="btn btn-default btn-sm disabled" title="<?php echo $Language->Phrase("PagerNext") ?>"><span class="icon-next ewIcon"></span></a>
	<?php } ?>
<!--last page button-->
	<?php if ($lesson_view->Pager->LastButton->Enabled) { ?>
	<a class="btn btn-default btn-sm" title="<?php echo $Language->Phrase("PagerLast") ?>" href="<?php echo $lesson_view->PageUrl() ?>start=<?php echo $lesson_view->Pager->LastButton->Start ?>"><span class="icon-last ewIcon"></span></a>
	<?php } else { ?>
...
<span>&nbsp;<?php echo $Language->Phrase("of") ?>&nbsp;<?php echo $lesson_view->Pager->PageCount ?></span>
</div>
<?php } ?>
<div class="clearfix"></div>
</form>
<?php } ?>
<?php } ?>
<form name="flessonview" id="flessonview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($lesson_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $lesson_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="lesson">
<input type="hidden" name="modal" value="<?php echo intval($lesson_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($lesson->lesson_id->Visible) { // lesson_id ?>
	<tr id="r_lesson_id">
		<td class="col-sm-2"><span id="elh_lesson_lesson_id"><?php echo $lesson->lesson_id->FldCaption() ?></span></td>
...
<?php echo $lesson->lesson_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->subject_id->Visible) { // subject_id ?>
	<tr id="r_subject_id">
		<td class="col-sm-2"><span id="elh_lesson_subject_id"><?php echo $lesson->subject_id->FldCaption() ?></span></td>
...
<?php echo $lesson->subject_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->title->Visible) { // title ?>
	<tr id="r_title">
		<td class="col-sm-2"><span id="elh_lesson_title"><?php echo $lesson->title->FldCaption() ?></span></td>
		<td data-name="title"<?php echo $lesson->title->CellAttributes() ?>>
<span id="el_lesson_title">
<span<?php echo $lesson->title->ViewAttributes() ?>>
<?php echo $lesson->title->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->description->Visible) { // description ?>
	<tr id="r_description">
		<td class="col-sm-2"><span id="elh_lesson_description"><?php echo $lesson->description->FldCaption() ?></span></td>
		<td data-name="description"<?php echo $lesson->description->CellAttributes() ?>>
<span id="el_lesson_description">
<span<?php echo $lesson->description->ViewAttributes() ?>>
<?php echo $lesson->description->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->detail->Visible) { // detail ?>
	<tr id="r_detail">
		<td class="col-sm-2"><span id="elh_lesson_detail"><?php echo $lesson->detail->FldCaption() ?></span></td>
		<td data-name="detail"<?php echo $lesson->detail->CellAttributes() ?>>
<span id="el_lesson_detail">
<span<?php echo $lesson->detail->ViewAttributes() ?>>
<?php echo $lesson->detail->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->video->Visible) { // video ?>
	<tr id="r_video">
		<td class="col-sm-2"><span id="elh_lesson_video"><?php echo $lesson->video->FldCaption() ?></span></td>
		<td data-name="video"<?php echo $lesson->video->CellAttributes() ?>>
<span id="el_lesson_video">
<span<?php echo $lesson->video->ViewAttributes() ?>>
<?php echo $lesson->video->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->reference->Visible) { // reference ?>
	<tr id="r_reference">
		<td class="col-sm-2"><span id="elh_lesson_reference"><?php echo $lesson->reference->FldCaption() ?></span></td>
		<td data-name="reference"<?php echo $lesson->reference->CellAttributes() ?>>
<span id="el_lesson_reference">
<span<?php echo $lesson->reference->ViewAttributes() ?>>
<?php echo $lesson->reference->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->image->Visible) { // image ?>
	<tr id="r_image">
		<td class="col-sm-2"><span id="elh_lesson_image"><?php echo $lesson->image->FldCaption() ?></span></td>
		<td data-name="image"<?php echo $lesson->image->CellAttributes() ?>>
<span id="el_lesson_image">
<span>
<?php echo ew_GetFileViewTag($lesson->image, $lesson->image->ViewValue) ?>
</span>
</span>
</td>
	</tr>
...
<?php if ($lesson->status->Visible) { // status ?>
	<tr id="r_status">
		<td class="col-sm-2"><span id="elh_lesson_status"><?php echo $lesson->status->FldCaption() ?></span></td>
		<td data-name="status"<?php echo $lesson->status->CellAttributes() ?>>
<span id="el_lesson_status">
<span<?php echo $lesson->status->ViewAttributes() ?>>
<?php echo $lesson->status->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($lesson->create_date->Visible) { // create_date ?>
	<tr id="r_create_date">
		<td class="col-sm-2"><span id="elh_lesson_create_date"><?php echo $lesson->create_date->FldCaption() ?></span></td>
		<td data-name="create_date"<?php echo $lesson->create_date->CellAttributes() ?>>
<span id="el_lesson_create_date">
<span<?php echo $lesson->create_date->ViewAttributes() ?>>
<?php echo $lesson->create_date->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
