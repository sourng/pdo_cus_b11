...
class cdefault {
	...
	function Page_Main() {
		...
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("instructorlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("lessonlist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("marketinglist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("skilllist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("slidelist.php");
		if ($Security->IsLoggedIn())
			$this->Page_Terminate("student_subjectlist.php");
		if ($Security->IsLoggedIn())
