...
fblogadd.Lists["x_status"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fblogadd.Lists["x_status"].Options = <?php echo json_encode($blog_add->status->Options()) ?>;
...
<?php if ($blog->title->Visible) { // title ?>
	<div id="r_title" class="form-group">
		<label id="elh_blog_title" for="x_title" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->title->FldCaption() ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->title->CellAttributes() ?>>
...
<?php if ($blog->description->Visible) { // description ?>
	<div id="r_description" class="form-group">
		<label id="elh_blog_description" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->description->FldCaption() ?></label>
...
<script type="text/javascript">
ew_CreateEditor("fblogadd", "x_description", 0, 0, <?php echo ($blog->description->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($blog->detail->Visible) { // detail ?>
	<div id="r_detail" class="form-group">
		<label id="elh_blog_detail" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->detail->FldCaption() ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->detail->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateEditor("fblogadd", "x_detail", 35, 4, <?php echo ($blog->detail->ReadOnly || FALSE) ? "true" : "false" ?>);
</script>
</span>
...
<?php if ($blog->image->Visible) { // image ?>
	<div id="r_image" class="form-group">
		<label id="elh_blog_image" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->image->FldCaption() ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->image->CellAttributes() ?>>
...
<?php if ($blog->create_date->Visible) { // create_date ?>
	<div id="r_create_date" class="form-group">
		<label id="elh_blog_create_date" for="x_create_date" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->create_date->FldCaption() ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->create_date->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fblogadd", "x_create_date", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($blog->user_id->Visible) { // user_id ?>
	<div id="r_user_id" class="form-group">
		<label id="elh_blog_user_id" for="x_user_id" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->user_id->FldCaption() ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->user_id->CellAttributes() ?>>
...
<?php if ($blog->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_blog_status" class="<?php echo $blog_add->LeftColumnClass ?>"><?php echo $blog->status->FldCaption() ?></label>
		<div class="<?php echo $blog_add->RightColumnClass ?>"><div<?php echo $blog->status->CellAttributes() ?>>
