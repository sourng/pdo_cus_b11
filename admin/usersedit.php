...
class cusers_edit extends cusers {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// oauth_provider
			$this->oauth_provider->SetDbValueDef($rsnew, $this->oauth_provider->CurrentValue, "", $this->oauth_provider->ReadOnly);

			// oauth_uid
			$this->oauth_uid->SetDbValueDef($rsnew, $this->oauth_uid->CurrentValue, "", $this->oauth_uid->ReadOnly);
			...
			// locale
			$this->locale->SetDbValueDef($rsnew, $this->locale->CurrentValue, "", $this->locale->ReadOnly);
			...
			if ($this->picture->Visible && !$this->picture->Upload->KeepFile) {
				...
				if (!ew_Empty($this->picture->Upload->FileName)) {
					...
					$this->picture->SetDbValueDef($rsnew, $this->picture->Upload->FileName, "", $this->picture->ReadOnly);
				}
			}
...
<?php if ($users->oauth_provider->Visible) { // oauth_provider ?>
	<div id="r_oauth_provider" class="form-group">
		<label id="elh_users_oauth_provider" for="x_oauth_provider" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->oauth_provider->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->oauth_provider->CellAttributes() ?>>
...
<?php if ($users->oauth_uid->Visible) { // oauth_uid ?>
	<div id="r_oauth_uid" class="form-group">
		<label id="elh_users_oauth_uid" for="x_oauth_uid" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->oauth_uid->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->oauth_uid->CellAttributes() ?>>
...
<?php if ($users->locale->Visible) { // locale ?>
	<div id="r_locale" class="form-group">
		<label id="elh_users_locale" for="x_locale" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->locale->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->locale->CellAttributes() ?>>
...
<?php if ($users->cover->Visible) { // cover ?>
	<div id="r_cover" class="form-group">
		<label id="elh_users_cover" for="x_cover" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->cover->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->cover->CellAttributes() ?>>
...
<?php if ($users->picture->Visible) { // picture ?>
	<div id="r_picture" class="form-group">
		<label id="elh_users_picture" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->picture->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->picture->CellAttributes() ?>>
...
<?php if ($users->link->Visible) { // link ?>
	<div id="r_link" class="form-group">
		<label id="elh_users_link" for="x_link" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->link->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->link->CellAttributes() ?>>
...
<?php if ($users->created->Visible) { // created ?>
	<div id="r_created" class="form-group">
		<label id="elh_users_created" for="x_created" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->created->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->created->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fusersedit", "x_created", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($users->modified->Visible) { // modified ?>
	<div id="r_modified" class="form-group">
		<label id="elh_users_modified" for="x_modified" class="<?php echo $users_edit->LeftColumnClass ?>"><?php echo $users->modified->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $users_edit->RightColumnClass ?>"><div<?php echo $users->modified->CellAttributes() ?>>
...
<script type="text/javascript">
ew_CreateDateTimePicker("fusersedit", "x_modified", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
