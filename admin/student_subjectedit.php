...
$student_subject_edit = NULL; // Initialize page object first

class cstudent_subject_edit extends cstudent_subject {
	...
	// Page object name
	var $PageObjName = 'student_subject_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_stu_sub_id")) {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->stu_sub_id->FldIsDetailKey)
			$this->stu_sub_id->setFormValue($objForm->GetValue("x_stu_sub_id"));
...
// Create page object
if (!isset($student_subject_edit)) $student_subject_edit = new cstudent_subject_edit();

// Page init
$student_subject_edit->Page_Init();

// Page main
$student_subject_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$student_subject_edit->Page_Render();
?>
...
var CurrentForm = fstudent_subjectedit = new ew_Form("fstudent_subjectedit", "edit");

// Validate form
fstudent_subjectedit.Validate = function() {
...
fstudent_subjectedit.Form_CustomValidate = 
...
fstudent_subjectedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $student_subject_edit->ShowPageHeader(); ?>
<?php
$student_subject_edit->ShowMessage();
?>
<form name="fstudent_subjectedit" id="fstudent_subjectedit" class="<?php echo $student_subject_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($student_subject_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $student_subject_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="student_subject">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($student_subject_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($student_subject->stu_sub_id->Visible) { // stu_sub_id ?>
	<div id="r_stu_sub_id" class="form-group">
		<label id="elh_student_subject_stu_sub_id" class="<?php echo $student_subject_edit->LeftColumnClass ?>"><?php echo $student_subject->stu_sub_id->FldCaption() ?></label>
		<div class="<?php echo $student_subject_edit->RightColumnClass ?>"><div<?php echo $student_subject->stu_sub_id->CellAttributes() ?>>
...
<input type="hidden" data-table="student_subject" data-field="x_stu_sub_id" name="x_stu_sub_id" id="x_stu_sub_id" value="<?php echo ew_HtmlEncode($student_subject->stu_sub_id->CurrentValue) ?>">
<?php echo $student_subject->stu_sub_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($student_subject->stu_id->Visible) { // stu_id ?>
	<div id="r_stu_id" class="form-group">
		<label id="elh_student_subject_stu_id" for="x_stu_id" class="<?php echo $student_subject_edit->LeftColumnClass ?>"><?php echo $student_subject->stu_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_subject_edit->RightColumnClass ?>"><div<?php echo $student_subject->stu_id->CellAttributes() ?>>
...
<input type="hidden" data-table="student_subject" data-field="x_stu_id" name="x_stu_id" id="x_stu_id" value="<?php echo ew_HtmlEncode($student_subject->stu_id->CurrentValue) ?>">
...
<?php if ($student_subject->subject_id->Visible) { // subject_id ?>
	<div id="r_subject_id" class="form-group">
		<label id="elh_student_subject_subject_id" for="x_subject_id" class="<?php echo $student_subject_edit->LeftColumnClass ?>"><?php echo $student_subject->subject_id->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $student_subject_edit->RightColumnClass ?>"><div<?php echo $student_subject->subject_id->CellAttributes() ?>>
...
<input type="hidden" data-table="student_subject" data-field="x_subject_id" name="x_subject_id" id="x_subject_id" value="<?php echo ew_HtmlEncode($student_subject->subject_id->CurrentValue) ?>">
...
<?php if ($student_subject->start_date->Visible) { // start_date ?>
	<div id="r_start_date" class="form-group">
		<label id="elh_student_subject_start_date" for="x_start_date" class="<?php echo $student_subject_edit->LeftColumnClass ?>"><?php echo $student_subject->start_date->FldCaption() ?></label>
		<div class="<?php echo $student_subject_edit->RightColumnClass ?>"><div<?php echo $student_subject->start_date->CellAttributes() ?>>
...
<?php if ($student_subject->note->Visible) { // note ?>
	<div id="r_note" class="form-group">
		<label id="elh_student_subject_note" for="x_note" class="<?php echo $student_subject_edit->LeftColumnClass ?>"><?php echo $student_subject->note->FldCaption() ?></label>
		<div class="<?php echo $student_subject_edit->RightColumnClass ?>"><div<?php echo $student_subject->note->CellAttributes() ?>>
...
<?php if (!$student_subject_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $student_subject_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $student_subject_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
fstudent_subjectedit.Init();
</script>
<?php
$student_subject_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$student_subject_edit->Page_Terminate();
?>
