...
define("EW_PROJECT_NAME", "pdo_cus_b11", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{0173B271-55C6-4AFA-9041-2C717884BBF4}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '39aHOYm3sXRmxT6l', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/pdo_cus_b11.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "pdo_cus_b11", "qs" => "`", "qe" => "`");
...
// Audit trail
define("EW_AUDIT_TRAIL_PATH", "../uploads/", TRUE); // Audit trail path (relative to app root)
