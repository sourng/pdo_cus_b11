...
$skill_edit = NULL; // Initialize page object first

class cskill_edit extends cskill {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// skill_title
			$this->skill_title->SetDbValueDef($rsnew, $this->skill_title->CurrentValue, NULL, $this->skill_title->ReadOnly);

			// skill_detail
			$this->skill_detail->SetDbValueDef($rsnew, $this->skill_detail->CurrentValue, NULL, $this->skill_detail->ReadOnly);

			// skill_image
			$this->skill_image->SetDbValueDef($rsnew, $this->skill_image->CurrentValue, NULL, $this->skill_image->ReadOnly);
...
// Create page object
if (!isset($skill_edit)) $skill_edit = new cskill_edit();

// Page init
$skill_edit->Page_Init();

// Page main
$skill_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$skill_edit->Page_Render();
?>
...
var CurrentForm = fskilledit = new ew_Form("fskilledit", "edit");

// Validate form
fskilledit.Validate = function() {
...
fskilledit.Form_CustomValidate = 
...
fskilledit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $skill_edit->ShowPageHeader(); ?>
<?php
$skill_edit->ShowMessage();
?>
<form name="fskilledit" id="fskilledit" class="<?php echo $skill_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($skill_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $skill_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="skill">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($skill_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($skill->skill_id->Visible) { // skill_id ?>
	<div id="r_skill_id" class="form-group">
		<label id="elh_skill_skill_id" class="<?php echo $skill_edit->LeftColumnClass ?>"><?php echo $skill->skill_id->FldCaption() ?></label>
		<div class="<?php echo $skill_edit->RightColumnClass ?>"><div<?php echo $skill->skill_id->CellAttributes() ?>>
<span id="el_skill_skill_id">
<span<?php echo $skill->skill_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $skill->skill_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="skill" data-field="x_skill_id" name="x_skill_id" id="x_skill_id" value="<?php echo ew_HtmlEncode($skill->skill_id->CurrentValue) ?>">
<?php echo $skill->skill_id->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($skill->skill_title->Visible) { // skill_title ?>
	<div id="r_skill_title" class="form-group">
		<label id="elh_skill_skill_title" for="x_skill_title" class="<?php echo $skill_edit->LeftColumnClass ?>"><?php echo $skill->skill_title->FldCaption() ?></label>
		<div class="<?php echo $skill_edit->RightColumnClass ?>"><div<?php echo $skill->skill_title->CellAttributes() ?>>
...
<?php if ($skill->skill_detail->Visible) { // skill_detail ?>
	<div id="r_skill_detail" class="form-group">
		<label id="elh_skill_skill_detail" for="x_skill_detail" class="<?php echo $skill_edit->LeftColumnClass ?>"><?php echo $skill->skill_detail->FldCaption() ?></label>
		<div class="<?php echo $skill_edit->RightColumnClass ?>"><div<?php echo $skill->skill_detail->CellAttributes() ?>>
...
<?php if ($skill->skill_image->Visible) { // skill_image ?>
	<div id="r_skill_image" class="form-group">
		<label id="elh_skill_skill_image" for="x_skill_image" class="<?php echo $skill_edit->LeftColumnClass ?>"><?php echo $skill->skill_image->FldCaption() ?></label>
		<div class="<?php echo $skill_edit->RightColumnClass ?>"><div<?php echo $skill->skill_image->CellAttributes() ?>>
...
<?php if ($skill->status->Visible) { // status ?>
	<div id="r_status" class="form-group">
		<label id="elh_skill_status" for="x_status" class="<?php echo $skill_edit->LeftColumnClass ?>"><?php echo $skill->status->FldCaption() ?></label>
		<div class="<?php echo $skill_edit->RightColumnClass ?>"><div<?php echo $skill->status->CellAttributes() ?>>
...
<?php if (!$skill_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $skill_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $skill_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
