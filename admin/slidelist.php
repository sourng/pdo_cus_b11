...
class cslide_list extends cslide {
	...
	function EmptyRow() {
		...
		if ($objForm->HasValue("x_status") && $objForm->HasValue("o_status") && $this->status->CurrentValue <> $this->status->OldValue)
			return FALSE;
		if ($objForm->HasValue("x_url") && $objForm->HasValue("o_url") && $this->url->CurrentValue <> $this->url->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	function RenderListOptions() {
		...
		if ($Security->IsLoggedIn()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewEdit\" title=\"" . $editcaption . "\" data-table=\"slide\" data-caption=\"" . $editcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'SaveBtn',url:'" . ew_HtmlEncode($this->EditUrl) . "'});\">" . $Language->Phrase("EditLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($Security->IsLoggedIn()) {
			if (ew_IsMobile())
				...
				$oListOpt->Body = "<a class=\"ewRowLink ewCopy\" title=\"" . $copycaption . "\" data-table=\"slide\" data-caption=\"" . $copycaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'AddBtn',url:'" . ew_HtmlEncode($this->CopyUrl) . "'});\">" . $Language->Phrase("CopyLink") . "</a>";
		} else {
			$oListOpt->Body = "";
		}
		...
		if ($this->CurrentAction == "gridedit" && is_numeric($this->RowIndex)) {
			$this->MultiSelectKey .= "<input type=\"hidden\" name=\"" . $KeyName . "\" id=\"" . $KeyName . "\" value=\"" . $this->slide_id->CurrentValue . "\">";
		}
	...
	function SetupOtherOptions() {
		...
		if (ew_IsMobile())
			...
			$item->Body = "<a class=\"ewAddEdit ewAdd\" title=\"" . $addcaption . "\" data-table=\"slide\" data-caption=\"" . $addcaption . "\" href=\"javascript:void(0);\" onclick=\"ew_ModalDialogShow({lnk:this,btn:'AddBtn',url:'" . ew_HtmlEncode($this->AddUrl) . "'});\">" . $Language->Phrase("AddLink") . "</a>";
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fslidelist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->IsLoggedIn());
	...
	function RenderRow() {
		...
		$this->url->ViewCustomAttributes = "";
			...
			$this->slide_id->EditValue = $this->slide_id->CurrentValue;
			$this->slide_id->ViewCustomAttributes = "";
	...
	function SetupExportOptions() {
		...
		$url = "";
		$item->Body = "<button id=\"emf_slide\" class=\"ewExportLink ewEmail\" title=\"" . $Language->Phrase("ExportToEmailText") . "\" data-caption=\"" . $Language->Phrase("ExportToEmailText") . "\" onclick=\"ew_EmailDialogShow({lnk:'emf_slide',hdr:ewLanguage.Phrase('ExportToEmailText'),f:document.fslidelist,sel:false" . $url . "});\">" . $Language->Phrase("ExportToEmail") . "</button>";
		$item->Visible = TRUE;
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		$fobj.data("rowindex", infix);
			...
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $slide->title->FldCaption(), $slide->title->ReqErrMsg)) ?>");
			...
			if (elm && !ew_CheckInteger(elm.value))
				return this.OnError(elm, "<?php echo ew_JsEncode2($slide->status->FldErrMsg()) ?>");
			elm = this.GetElements("x" + infix + "_url");
			if (elm && !ew_IsHidden(elm) && !ew_HasValue(elm))
				return this.OnError(elm, "<?php echo ew_JsEncode2(str_replace("%s", $slide->url->FldCaption(), $slide->url->ReqErrMsg)) ?>");
...
<?php if ($slide->title->Visible) { // title ?>
	<?php if ($slide->SortUrl($slide->title) == "") { ?>
		<th data-name="title" class="<?php echo $slide->title->HeaderCellClass() ?>"><div id="elh_slide_title" class="slide_title"><div class="ewTableHeaderCaption"><?php echo $slide->title->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="title" class="<?php echo $slide->title->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->title) ?>',1);"><div id="elh_slide_title" class="slide_title">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->title->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($slide->title->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->title->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($slide->description->Visible) { // description ?>
	<?php if ($slide->SortUrl($slide->description) == "") { ?>
		<th data-name="description" class="<?php echo $slide->description->HeaderCellClass() ?>"><div id="elh_slide_description" class="slide_description"><div class="ewTableHeaderCaption"><?php echo $slide->description->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="description" class="<?php echo $slide->description->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->description) ?>',1);"><div id="elh_slide_description" class="slide_description">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->description->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($slide->description->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->description->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($slide->img->Visible) { // img ?>
	<?php if ($slide->SortUrl($slide->img) == "") { ?>
		<th data-name="img" class="<?php echo $slide->img->HeaderCellClass() ?>"><div id="elh_slide_img" class="slide_img"><div class="ewTableHeaderCaption"><?php echo $slide->img->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="img" class="<?php echo $slide->img->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->img) ?>',1);"><div id="elh_slide_img" class="slide_img">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->img->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($slide->img->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->img->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($slide->status->Visible) { // status ?>
	<?php if ($slide->SortUrl($slide->status) == "") { ?>
		<th data-name="status" class="<?php echo $slide->status->HeaderCellClass() ?>"><div id="elh_slide_status" class="slide_status"><div class="ewTableHeaderCaption"><?php echo $slide->status->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="status" class="<?php echo $slide->status->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->status) ?>',1);"><div id="elh_slide_status" class="slide_status">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->status->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($slide->status->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->status->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($slide->url->Visible) { // url ?>
	<?php if ($slide->SortUrl($slide->url) == "") { ?>
		<th data-name="url" class="<?php echo $slide->url->HeaderCellClass() ?>"><div id="elh_slide_url" class="slide_url"><div class="ewTableHeaderCaption"><?php echo $slide->url->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="url" class="<?php echo $slide->url->HeaderCellClass() ?>"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $slide->SortUrl($slide->url) ?>',1);"><div id="elh_slide_url" class="slide_url">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $slide->url->FldCaption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ewTableHeaderSort"><?php if ($slide->url->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($slide->url->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
if ($slide->CurrentAction == "gridedit")
	$slide_list->RowIndex = 0;
while ($slide_list->RecCnt < $slide_list->StopRec) {
	$slide_list->RecCnt++;
	if (intval($slide_list->RecCnt) >= intval($slide_list->StartRec)) {
		$slide_list->RowCnt++;
		if ($slide->CurrentAction == "gridadd" || $slide->CurrentAction == "gridedit" || $slide->CurrentAction == "F") {
			$slide_list->RowIndex++;
			$objForm->Index = $slide_list->RowIndex;
			if ($objForm->HasValue($slide_list->FormActionName))
				$slide_list->RowAction = strval($objForm->GetValue($slide_list->FormActionName));
			elseif ($slide->CurrentAction == "gridadd")
				$slide_list->RowAction = "insert";
			else
				$slide_list->RowAction = "";
		}
		...
		if ($slide->CurrentAction == "gridadd") {
			$slide_list->LoadRowValues(); // Load default values
		} else {
			$slide_list->LoadRowValues($slide_list->Recordset); // Load row values
		}
		$slide->RowType = EW_ROWTYPE_VIEW; // Render view
		if ($slide->CurrentAction == "gridedit") { // Grid edit
			if ($slide->EventCancelled) {
				$slide_list->RestoreCurrentRowFormValues($slide_list->RowIndex); // Restore form values
			}
			if ($slide_list->RowAction == "insert")
				$slide->RowType = EW_ROWTYPE_ADD; // Render add
			else
				$slide->RowType = EW_ROWTYPE_EDIT; // Render edit
		}
		if ($slide->CurrentAction == "gridedit" && ($slide->RowType == EW_ROWTYPE_EDIT || $slide->RowType == EW_ROWTYPE_ADD) && $slide->EventCancelled) // Update failed
			$slide_list->RestoreCurrentRowFormValues($slide_list->RowIndex); // Restore form values
		...
		if ($slide_list->RowAction <> "delete" && $slide_list->RowAction <> "insertdelete" && !($slide_list->RowAction == "insert" && $slide->CurrentAction == "F" && $slide_list->EmptyRow())) {
?>
...
<input type="hidden" data-table="slide" data-field="x_slide_id" name="o<?php echo $slide_list->RowIndex ?>_slide_id" id="o<?php echo $slide_list->RowIndex ?>_slide_id" value="<?php echo ew_HtmlEncode($slide->slide_id->OldValue) ?>">
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_slide_id" class="form-group slide_slide_id">
<span<?php echo $slide->slide_id->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $slide->slide_id->EditValue ?></p></span>
</span>
<input type="hidden" data-table="slide" data-field="x_slide_id" name="x<?php echo $slide_list->RowIndex ?>_slide_id" id="x<?php echo $slide_list->RowIndex ?>_slide_id" value="<?php echo ew_HtmlEncode($slide->slide_id->CurrentValue) ?>">
<?php } ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($slide->title->Visible) { // title ?>
		<td data-name="title"<?php echo $slide->title->CellAttributes() ?>>
<?php if ($slide->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_title" class="form-group slide_title">
<input type="text" data-table="slide" data-field="x_title" name="x<?php echo $slide_list->RowIndex ?>_title" id="x<?php echo $slide_list->RowIndex ?>_title" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->title->getPlaceHolder()) ?>" value="<?php echo $slide->title->EditValue ?>"<?php echo $slide->title->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_title" name="o<?php echo $slide_list->RowIndex ?>_title" id="o<?php echo $slide_list->RowIndex ?>_title" value="<?php echo ew_HtmlEncode($slide->title->OldValue) ?>">
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_title" class="form-group slide_title">
<input type="text" data-table="slide" data-field="x_title" name="x<?php echo $slide_list->RowIndex ?>_title" id="x<?php echo $slide_list->RowIndex ?>_title" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->title->getPlaceHolder()) ?>" value="<?php echo $slide->title->EditValue ?>"<?php echo $slide->title->EditAttributes() ?>>
...
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_title" class="slide_title">
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($slide->description->Visible) { // description ?>
		<td data-name="description"<?php echo $slide->description->CellAttributes() ?>>
<?php if ($slide->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_description" class="form-group slide_description">
<input type="text" data-table="slide" data-field="x_description" name="x<?php echo $slide_list->RowIndex ?>_description" id="x<?php echo $slide_list->RowIndex ?>_description" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->description->getPlaceHolder()) ?>" value="<?php echo $slide->description->EditValue ?>"<?php echo $slide->description->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_description" name="o<?php echo $slide_list->RowIndex ?>_description" id="o<?php echo $slide_list->RowIndex ?>_description" value="<?php echo ew_HtmlEncode($slide->description->OldValue) ?>">
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_description" class="form-group slide_description">
<input type="text" data-table="slide" data-field="x_description" name="x<?php echo $slide_list->RowIndex ?>_description" id="x<?php echo $slide_list->RowIndex ?>_description" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->description->getPlaceHolder()) ?>" value="<?php echo $slide->description->EditValue ?>"<?php echo $slide->description->EditAttributes() ?>>
...
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_description" class="slide_description">
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($slide->status->Visible) { // status ?>
		<td data-name="status"<?php echo $slide->status->CellAttributes() ?>>
<?php if ($slide->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_status" class="form-group slide_status">
<input type="text" data-table="slide" data-field="x_status" name="x<?php echo $slide_list->RowIndex ?>_status" id="x<?php echo $slide_list->RowIndex ?>_status" size="30" placeholder="<?php echo ew_HtmlEncode($slide->status->getPlaceHolder()) ?>" value="<?php echo $slide->status->EditValue ?>"<?php echo $slide->status->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_status" name="o<?php echo $slide_list->RowIndex ?>_status" id="o<?php echo $slide_list->RowIndex ?>_status" value="<?php echo ew_HtmlEncode($slide->status->OldValue) ?>">
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_status" class="form-group slide_status">
<input type="text" data-table="slide" data-field="x_status" name="x<?php echo $slide_list->RowIndex ?>_status" id="x<?php echo $slide_list->RowIndex ?>_status" size="30" placeholder="<?php echo ew_HtmlEncode($slide->status->getPlaceHolder()) ?>" value="<?php echo $slide->status->EditValue ?>"<?php echo $slide->status->EditAttributes() ?>>
...
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_status" class="slide_status">
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($slide->url->Visible) { // url ?>
		<td data-name="url"<?php echo $slide->url->CellAttributes() ?>>
<?php if ($slide->RowType == EW_ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_url" class="form-group slide_url">
<input type="text" data-table="slide" data-field="x_url" name="x<?php echo $slide_list->RowIndex ?>_url" id="x<?php echo $slide_list->RowIndex ?>_url" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->url->getPlaceHolder()) ?>" value="<?php echo $slide->url->EditValue ?>"<?php echo $slide->url->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_url" name="o<?php echo $slide_list->RowIndex ?>_url" id="o<?php echo $slide_list->RowIndex ?>_url" value="<?php echo ew_HtmlEncode($slide->url->OldValue) ?>">
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_url" class="form-group slide_url">
<input type="text" data-table="slide" data-field="x_url" name="x<?php echo $slide_list->RowIndex ?>_url" id="x<?php echo $slide_list->RowIndex ?>_url" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->url->getPlaceHolder()) ?>" value="<?php echo $slide->url->EditValue ?>"<?php echo $slide->url->EditAttributes() ?>>
...
<?php } ?>
<?php if ($slide->RowType == EW_ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $slide_list->RowCnt ?>_slide_url" class="slide_url">
...
<?php
	...
	if ($slide->CurrentAction <> "gridadd")
		if (!$slide_list->Recordset->EOF) $slide_list->Recordset->MoveNext();
}
?>
<?php
	if ($slide->CurrentAction == "gridadd" || $slide->CurrentAction == "gridedit") {
		$slide_list->RowIndex = '$rowindex$';
		$slide_list->LoadRowValues();

		// Set row properties
		$slide->ResetAttrs();
		$slide->RowAttrs = array_merge($slide->RowAttrs, array('data-rowindex'=>$slide_list->RowIndex, 'id'=>'r0_slide', 'data-rowtype'=>EW_ROWTYPE_ADD));
		ew_AppendClass($slide->RowAttrs["class"], "ewTemplate");
...
// Render list options (body, left)
$slide_list->ListOptions->Render("body", "left", $slide_list->RowIndex);
?>
	<?php if ($slide->slide_id->Visible) { // slide_id ?>
		<td data-name="slide_id">
<input type="hidden" data-table="slide" data-field="x_slide_id" name="o<?php echo $slide_list->RowIndex ?>_slide_id" id="o<?php echo $slide_list->RowIndex ?>_slide_id" value="<?php echo ew_HtmlEncode($slide->slide_id->OldValue) ?>">
</td>
	<?php } ?>
	<?php if ($slide->title->Visible) { // title ?>
		<td data-name="title">
<span id="el$rowindex$_slide_title" class="form-group slide_title">
<input type="text" data-table="slide" data-field="x_title" name="x<?php echo $slide_list->RowIndex ?>_title" id="x<?php echo $slide_list->RowIndex ?>_title" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->title->getPlaceHolder()) ?>" value="<?php echo $slide->title->EditValue ?>"<?php echo $slide->title->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_title" name="o<?php echo $slide_list->RowIndex ?>_title" id="o<?php echo $slide_list->RowIndex ?>_title" value="<?php echo ew_HtmlEncode($slide->title->OldValue) ?>">
</td>
...
<span id="el$rowindex$_slide_description" class="form-group slide_description">
<input type="text" data-table="slide" data-field="x_description" name="x<?php echo $slide_list->RowIndex ?>_description" id="x<?php echo $slide_list->RowIndex ?>_description" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->description->getPlaceHolder()) ?>" value="<?php echo $slide->description->EditValue ?>"<?php echo $slide->description->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_description" name="o<?php echo $slide_list->RowIndex ?>_description" id="o<?php echo $slide_list->RowIndex ?>_description" value="<?php echo ew_HtmlEncode($slide->description->OldValue) ?>">
</td>
...
<input type="hidden" data-table="slide" data-field="x_img" name="o<?php echo $slide_list->RowIndex ?>_img" id="o<?php echo $slide_list->RowIndex ?>_img" value="<?php echo ew_HtmlEncode($slide->img->OldValue) ?>">
	...
	<?php if ($slide->status->Visible) { // status ?>
		<td data-name="status">
<span id="el$rowindex$_slide_status" class="form-group slide_status">
<input type="text" data-table="slide" data-field="x_status" name="x<?php echo $slide_list->RowIndex ?>_status" id="x<?php echo $slide_list->RowIndex ?>_status" size="30" placeholder="<?php echo ew_HtmlEncode($slide->status->getPlaceHolder()) ?>" value="<?php echo $slide->status->EditValue ?>"<?php echo $slide->status->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_status" name="o<?php echo $slide_list->RowIndex ?>_status" id="o<?php echo $slide_list->RowIndex ?>_status" value="<?php echo ew_HtmlEncode($slide->status->OldValue) ?>">
</td>
	...
	<?php if ($slide->url->Visible) { // url ?>
		<td data-name="url">
<span id="el$rowindex$_slide_url" class="form-group slide_url">
<input type="text" data-table="slide" data-field="x_url" name="x<?php echo $slide_list->RowIndex ?>_url" id="x<?php echo $slide_list->RowIndex ?>_url" size="30" maxlength="250" placeholder="<?php echo ew_HtmlEncode($slide->url->getPlaceHolder()) ?>" value="<?php echo $slide->url->EditValue ?>"<?php echo $slide->url->EditAttributes() ?>>
</span>
<input type="hidden" data-table="slide" data-field="x_url" name="o<?php echo $slide_list->RowIndex ?>_url" id="o<?php echo $slide_list->RowIndex ?>_url" value="<?php echo ew_HtmlEncode($slide->url->OldValue) ?>">
</td>
...
// Render list options (body, right)
$slide_list->ListOptions->Render("body", "right", $slide_list->RowIndex);
?>
<script type="text/javascript">
fslidelist.UpdateOpts(<?php echo $slide_list->RowIndex ?>);
</script>
...
<?php } ?>
<?php if ($slide->CurrentAction == "gridedit") { ?>
...
<?php echo $slide_list->MultiSelectKey ?>
<?php } ?>
