...
<?php if ($blog->id->Visible) { // id ?>
		<th class="<?php echo $blog->id->HeaderCellClass() ?>"><span id="elh_blog_id" class="blog_id"><?php echo $blog->id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->title->Visible) { // title ?>
		<th class="<?php echo $blog->title->HeaderCellClass() ?>"><span id="elh_blog_title" class="blog_title"><?php echo $blog->title->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->image->Visible) { // image ?>
		<th class="<?php echo $blog->image->HeaderCellClass() ?>"><span id="elh_blog_image" class="blog_image"><?php echo $blog->image->FldCaption() ?></span></th>
<?php } ?>
<?php if ($blog->create_date->Visible) { // create_date ?>
		<th class="<?php echo $blog->create_date->HeaderCellClass() ?>"><span id="elh_blog_create_date" class="blog_create_date"><?php echo $blog->create_date->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php if ($blog->id->Visible) { // id ?>
		<td<?php echo $blog->id->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_id" class="blog_id">
...
<?php } ?>
<?php if ($blog->title->Visible) { // title ?>
		<td<?php echo $blog->title->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_title" class="blog_title">
...
<?php } ?>
<?php if ($blog->image->Visible) { // image ?>
		<td<?php echo $blog->image->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_image" class="blog_image">
<span>
...
<?php } ?>
<?php if ($blog->create_date->Visible) { // create_date ?>
		<td<?php echo $blog->create_date->CellAttributes() ?>>
<span id="el<?php echo $blog_delete->RowCnt ?>_blog_create_date" class="blog_create_date">
